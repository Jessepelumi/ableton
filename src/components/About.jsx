...
const About = () => {
    ...
    useEffect(() => {
        document.title = "Learn more about Ableton - maker of Live and Push | Ableton";
    }, []);
        ...
        <div className="about">
            ...
            <div className="header">
                <div className="header-image">
                    <img src="https://ableton-production.imgix.net/about/header.jpg" alt="" />
                    <h2>Ableton</h2>
                </div>
                <div className="header-text">
                    <h2>
                        We make <Link to="/live">Live</Link>, <Link to="/push">Push</Link> and <Link to="/link">Link</Link> ---- unique software and hardware for music creation and performance. With these products, our community of users creates amazing things.
                    </h2>
                    <p>
                ...
                <div className="header-image2">
                    <div className="image2-first">
                        <img src="https://ableton-production.imgix.net/about/photo-1.jpg" alt="" />
                    </div>
                    <div className="image2-second">
                        <img src="https://ableton-production.imgix.net/about/photo-2.jpg" alt="" />
                    </div>
                </div>
                <div className="header-text">
                    <h2>
                ...
                <div className="header-video">
                    <a href="https://www.youtube.com/watch?v=9SbnhgjeyXA" target="_blank">
                        <figure>
                            <div>
                                <img src="https://ableton-production.imgix.net/about/poster-juanpe.jpg?auto=compress%2Cformat&dpr=2&ixjsv=1.1.3&q=50&w=720" alt="" />
                                <span><PlayCircle size={120} weight="fill" /></span>
                            </div>
                            <figcaption>
                ...
                <div className="header-image3">
                    <div className="image3-first">
                        <div>
                            <img src="https://ableton-production.imgix.net/about/photo-3.jpg" alt="" />
                        </div>
                        <div>
                            <img src="https://ableton-production.imgix.net/about/photo-4.jpg" alt="" />
                        </div>
                    </div>
                    <div className="image3-second">
                        <img src="https://ableton-production.imgix.net/about/photo-5.jpg" alt="" />
                    </div>
                </div>
                <div className="header-text">
                    <h2>
                ...
                <div className="header-image4">
                    <img src="https://ableton-production.imgix.net/about/poster-meet-the-makers.jpg?auto=format&dpr=2&fit=crop&fm=jpg&ixjsv=1.1.3&q=50&w=1200" alt="" />
                </div>
                <div className="header-text">
                    <h2>
                    ...
                    <p>
                        We work hard to foster an environment where people can grow both personally and professionally, and we strive to create a wealth of opportunities to learn from and with each other. <br />
                ...
                <div className="header-image5">
                    <div className="image5-container">
                        <div className="image5-first">
                            <img src="https://ableton-production.imgix.net/about/photo-6-a.jpg" alt="" />
                        </div>
                        <div className="image5-second">
                            <img src="https://ableton-production.imgix.net/about/photo-7.jpg" alt="" />
                        </div>
                    </div>
                </div>
                <div className="header-text">

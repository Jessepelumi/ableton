    ...
    <div className="help">
      ...
      <section className="learn">
        <div className="learn-container">
          <Link>
            <img
              src="https://ableton-production.imgix.net/help/learn-live.jpg?fit=crop&auto=format&fm=jpg"
              alt=""
            />
          </Link>
          <div>
        ...
        <div className="learn-container">
          <Link>
            <img
              src="https://ableton-production.imgix.net/help/learn-push.jpg?fit=crop&auto=format&fm=jpg"
              alt=""
            />
          </Link>
          <div>
            <h2>Learn Push</h2>
            <p>
              From setup to sound design and beyond - our growing collection of
              tutorials shows how you can make music with Push.
            </p>
            <Link>
        ...
        <div className="learn-container">
          <Link>
            <img
              src="https://ableton-production.imgix.net/help/learning-music.jpg?fit=crop&auto=format&fm=jpg"
              alt=""
            />
          </Link>
          <div>
            ...
            <p>
              ...
              harmonies, basslines, and song structure - and make music right in
              your browser.
            </p>
            <Link>
        ...
        <div className="learn-container">
          <Link>
            <img
              src="https://ableton-production.imgix.net/help/learning-synths.jpg?fit=crop&auto=format&fm=jpg"
              alt=""
            />
          </Link>
          <div>
        ...
        <div className="learn-container">
          <Link>
            <img
              src="https://ableton-production.imgix.net/help/making-music.jpg?fit=crop&auto=format&fm=jpg"
              alt=""
            />
          </Link>
          <div>
            ...
            <p>
              ...
              Dennis DeSantis' book on solving musical problems, making progress
      ...
      <aside>
        ...
        <div className="aside-container">
          ...
          <div>
            <h2>Learn Note</h2>
            <p>
              Find out how to play beats and melodies, sample your surroundings,
              and experiment with song structures in Note - an iOS app for
              musical sketching. Then send your Note sketches to Live using
              Ableton Cloud.
            </p>
            <Link>
              Check out the manual
          ...
          <div>
            ...
            <p>
              All over the globe, a growing group of trainers and institutions
              are offering approved Ableton teaching at all skill levels, both
          ...
          <div>
            ...
            <p>
              Practice your finger drumming skills with Melodics, a standalone
              app that offers a great way to learn and refine your playing. It's
              free to download and comes with 20 lessons to get you started.
            </p>
            <Link>
          ...
          <div>
            <h2>User Groups</h2>
            <p>
              For beginners and seasoned users alike, Ableton User Groups are
              open to any Live user who wants to share their knowledge and learn
              from others in person.
            </p>
            <Link>
      ...
      <aside>
        ...
        <div className="aside-container">
          <div>
            <h2>Sales support</h2>
            <p>
              Get in touch with us if you've got some questions before you buy a
              product, or if you need help with your order, license or the
            ...
            <p className="paragraph">
              ...
              therefore, our response time might be higher than expected. We ask
              for your patience and that you do not send multiple requests about
              the same issue; will get back to you as soon as possible. In the
              meantime, you can find solutions to common problems in our{" "}
